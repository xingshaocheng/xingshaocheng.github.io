 ...
 */
(function($) {
    var toggleHTML = '<div id="toctitle"><h2>文章目录</h2> <span class="toctoggle">[<a id="toctogglelink" class="internal" href="#">隐藏</a>]</span></div>';
    ...
    $.fn.toc = function(settings) {
        ...
        if (show && tocHTML) {
            ...
            var customToContainer = $("#"+config.containerDomId);
            if(customToContainer.length > 0){
            	customToContainer.prepend(replacedTocContainer);
            	customToContainer.show();
            }
            else{
